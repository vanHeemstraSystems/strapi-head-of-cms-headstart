...
Populate the files with the following code that we will come back to once our CMS Backend (using: Strapi) server is set up (see https://apps-bbdc-prd.asml.com/projects/DEVOPS/repos/pwc-content-management-systems/browse).
...
We are going to do some of the below work through the 'Admin' panel of the separately created Content Management Services backend (see https://apps-bbdc-prd.asml.com/projects/DEVOPS/repos/pwc-content-management-systems/browse).
...
For the value of ```HOST-AND-PORT-OF-CMS-BACKEND-SERVER``` consult the implementation of your ***CMS Backend*** as created from https://apps-bbdc-prd.asml.com/projects/DEVOPS/repos/pwc-content-management-systems/browse
